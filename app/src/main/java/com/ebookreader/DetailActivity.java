...
public class DetailActivity extends FragmentActivity implements AdapterView.OnItemClickListener {
    ...
    private String[] tag_5 = {"电器维修技术","保健养生", "种养殖技术", "计算机操作技能", "测验评估"};
    private String[] tag_6 = {"回归准备", "心理调适", "身份恢复", "亲情连线","社区融入","形式政策","就业指导","创业指导","测验评估"};
    private String[] tag_7 = {"爱国主义", "感恩教育", "心理健康","艺术教育","成功故事","国学经典" };
    ...
    private DetailAct_listview_Adapter adapter;   //listview adapter
